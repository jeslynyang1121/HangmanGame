...
public class Game {
    ...
    public String Guess(int numMistakes, int numCorrect) {
        if ((numMistakes == 6) || (numCorrect == length)) {
            return "";
        } else {
            System.out.println("Please guess a letter.");
            String gLetter = input.next();
    ...
    public String GameEnd(int mistakes) {
        if (mistakes == 6) {
            System.out.println("Game Over!");
        } else {
            System.out.println("Congrats! You guessed the word!");
        }
        System.out.println("\nIf you would like to play again, type \"replay\". If not, type \"end\".");
        return input.next();
    }
